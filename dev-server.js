...
/**
 * Servidor de desenvolvimento local que simula Supabase
 * Use este servidor enquanto não tiver credenciais reais do Supabase
 * 
 * Para usar:
...
app.get('/api/inspections/:id', (req, res) => {
  ...
  if (!inspection) {
    return res.status(404).json({ data: null, error: 'Inspeção não encontrada' });
  }
...
app.listen(PORT, () => {
  console.log('');
  console.log('╔════════════════════════════════════════════════════════╗');
  console.log('║  🚀 Servidor de Desenvolvimento Supabase Local        ║');
